	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<link href="MODUSER.css" rel="stylesheet" type="text/css" />
				<script type="text/javascript" src="MODUSER.js">
				</script>
							...
							<tr>
								<td>
									...
									<button id="ModifyId" class="button" type="button"
										...
										onclick="modifybtnEnable(); enbFilds(); samebtnSave(); modifybtn(); getFrontEndData('getFrontEndData');"
										onmousedown="">
...
">
							<xsl:for-each select="div/tbody">
								...
								<tr>
									...
									<td>
										<input type="text" id="cust_id" autocomplete="off"></input>
									</td>

								</tr>
								<img id="imgLov"
									onclick="frameinWin('LOV_MODUSER','MODUSER','List of Values Customer No');insertData('cust_id','cust_name')"
									src="Img/searcher.png" width="20" height="20"
									style="position: absolute;margin-left: 310px;margin-top: 59px;" />

								<div id="fetchData_div">
									<button id="fetchbtn" class="button" type="button"
										onclick="getCustomerDetails('UserMaintenanceModify')"
										onmousedown="">Fetch Data</button>
								</div>
								...
								<tr>
									...
									<td>
										<input type="text" id="cust_name" class="disabled-input"
								...
								<tr>
									...
									<td>
										<input type="password" id="cust_password" class="disabled-input"
											autocomplete="off"></input>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" id="cust_dept" class="disabled-input"
											autocomplete="off"></input>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" id="cust_email" class="disabled-input"
											autocomplete="off"></input>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" id="cust_manager" class="disabled-input"
											autocomplete="off"></input>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" id="cust_ldap" class="disabled-input"
											autocomplete="off"></input>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" id="cust_phone" maxlength="10"
											minlength="10" class="disabled-input" autocomplete="off"
											title="Please enter exactly 10 digits"></input>
									</td>
								</tr>
								<br></br>
				...
				<table>
					<xsl:for-each select="div/header">
						<div id="roleScreen">
							...
							<div id="roletable">
								<table id="dataTable"
									style="position: fixed;right: 260px;width: 428px;top: 215px; overflow:scroll; overflow-x:hidden;">
									<thead id="table_css">
										<th>Check</th>
										<th style=" width: 136px; ">Role Id</th>
										<th></th>
										<th style=" width: 232px; ">Role Desc</th>
									</thead>
										<tbody id="roleScreen"
										style="position: fixed;margin-left: -4px;top: 169px;overflow-y: scroll;scroll-behavior: smooth;height: 264px;top: 267px;"></tbody>
								</table>
