 ...
 */
 ...
 document.getElementById('msproj_id').disabled = true;
 document.getElementById("imgLov1").style.display="none";
 document.getElementById('subproj_id').disabled = true;
 document.getElementById('subproj_name').disabled = true;
 document.getElementById('substdate').disabled = true;
 document.getElementById('subendate').disabled = true;
 ...
 function resetValues(){
		 ...
		 * fetchbtnElem.style.display="none";
		 */
		 document.getElementById("mproj_id").value="";    // true
		 ...
		 document.getElementById("msproj_id").value="";
		 document.getElementById("subproj_id").value="";
		 document.getElementById("subproj_name").value="";
		 document.getElementById("substdate").value="";
		 document.getElementById("subendate").value="";
...
function deleteData(){
	...
	fetch(origin+"/"+parent.getProjectName()+"/Screen?function_id=TASKMANT&method=DELETE&proj_id="+proj_id)
...
function readOnlyf(){
	document.getElementById('proj_id').disabled = false;
	document.getElementById('proj_name').disabled = false;
	document.getElementById('stdate').disabled = false;
	document.getElementById('endate').disabled = false;
	document.getElementById('status').disabled = false;
	
	document.getElementById('mproj_id').disabled = false;
	document.getElementById('mproj_name').disabled = false;
	document.getElementById('mstdate').disabled = false;
	document.getElementById('mendate').disabled = false;
	document.getElementById('mstatus').disabled = false;
	
	document.getElementById('sproj_id').disabled = false;
	document.getElementById('sproj_name').disabled = false;
	document.getElementById('sstdate').disabled = false;
	document.getElementById('sendate').disabled = false;
