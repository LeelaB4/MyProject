...
function createBTN(){
	...
	document.getElementById("ModifyId").style.display="none"; 
	 ...
	 document.getElementById('ReopenId').style.display="none";
	 document.getElementById('pract_empid').disabled = false;
...
function createNew(){
	...
	document.getElementById("buttonSave").style.display=""; 
	 ...
	 document.getElementById('pract_type').disabled = false;
...
function readOnlyf(){
	document.getElementById('pract_email').readOnly = false;
	document.getElementById('pract_name').readOnly = false;
	document.getElementById('pract_org').readOnly = false;
	// document.getElementById('pract_type').readOnly = false;
	document.getElementById('pract_mob').readOnly = false;
	document.getElementById('pract_mgr').readOnly = false;
	document.getElementById('pract_joiningdate').readOnly = false;
	document.getElementById('pract_exitdate').readOnly = false;
	document.getElementById('pract_innotice').readOnly = false;
}
function readOnlyt(){
	
	 document.getElementById("pract_name").disabled = true;
	 document.getElementById("pract_org").disabled = true;
	 ...
	 document.getElementById("pract_mob").disabled = true;
	 document.getElementById("pract_mgr").disabled = true;
	 document.getElementById("pract_joiningdate").disabled = true;
	 document.getElementById("pract_exitdate").disabled = true;;
	 document.getElementById("pract_innotice").disabled = true;
	 document.getElementById('pract_type').disabled = true;
 ...
 * button: "Allright", });
 */
 let pract_empId = document.getElementById("pract_empid").value.trim();
 console.log("+++", pract_empId);
 
 
 fetch(origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTM&method=GET&pract_empid="+pract_empId)  
.then(function(response) {  
	// first then()
	 ...
	 // Refresh Cust_id
	document.getElementById("pract_empid").value="";
 ...
 .catch(function(error) {                        // catch
  ...
  fetch(origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTM&method=GET&pract_empid="+pract_empId).then(data=> data.json())
 .then((data) => {
...
function resetValues(){
 ...
 fetchbtnElem.style.display="none";
	 ...
	 document.getElementById("pract_org").value="";
	 document.getElementById("pract_type").value="";
	 document.getElementById("pract_empid").value="";
	 document.getElementById("pract_email").value="";
	 document.getElementById("pract_mob").value="";
	 document.getElementById("pract_mgr").value="";
	 document.getElementById("pract_joiningdate").value="";
	 document.getElementById("pract_exitdate").value="";
	 document.getElementById("pract_innotice").value="";
...
function modifybtn(){
	 ...
	 document.getElementById("DeleteId").disabled = false;
	 document.getElementById('pract_empid').readOnly = false;
...
function CustPost(method){
		...
		
	{
		if(method === "POST")
		{
		   url_send_data=origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTM&method=POST&pract_empid="+pract_Id+"&"+"pract_name="+pract_name+"&"+
	  ...
	  if(pract_mak !== userLogIn && document.getElementById("Approver_statement").value === "Unauthorize"  ){
			...
			if (document.getElementById("Once_Auth").value="Y" && document.getElementById("Approver_statement").value === "Unauthorize")	   {
				 modifybtn();
		 		 ...
		 		 url_send_data=origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTM&method=UPDATE&pract_empid="+pract_Id+"&"+"pract_name="+pract_name+"&"+
				 "pract_type="+pract_type+"&"+"pract_org="+pract_org+"&"+"pract_email="+pract_email+"&"+"pract_mob="+pract_mob+"&"+"pract_mgr="+pract_mgr+"&"+"pract_joiningdate="+
				 pract_joiningdate+"&"+"pract_exitdate="+pract_exitdate+"&"+"pract_innotice="+pract_innotice+"&"+"maker="+pract_mak+"&"+"maker_dt_stamp="+maker_dt_stamp+
				 "&"+"Approver="+Approver+"&"+"Aprovertime="+Aprovertime+"&"+"Status="+Status+"&"+"Approver_statement="+Approver_statement+"&"+"Once_Auth="+Once_Auth;  
...
function approveData(){
	if(document.getElementById("maker").value.trim() !== parent.document.getElementById("user_id").innerText.trim() && document.getElementById("Approver_statement").value.trim() === "Unauthorize" && document.getElementById("Once_Auth").value.trim() === "N"){
		...
		let pract_innotice = document.getElementById("pract_innotice").value;
		 ...
		 fetch(origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTM&method=APPROVE&pract_empid="+pract_Id+"&"+"pract_name="+pract_name+"&"+
		 "pract_type="+pract_type+"&"+"pract_org="+pract_org+"&"+"pract_email="+pract_email+"&"+"pract_mob="+pract_mob+"&"+"pract_mgr="+pract_mgr+"&"+"pract_joiningdate="+
		 pract_joiningdate+"&"+"pract_exitdate="+pract_exitdate+"&"+"pract_innotice="+pract_innotice+"&"+"maker="+pract_mak+"&"+"maker_dt_stamp="+maker_dt_stamp+
 ...
 function enbFilds(){
	 ...
	 */
	 ...
	 /*
		...
		document.getElementById("pract_name").style.enabled=true;
		document.getElementById('pract_name').disabled = true;
