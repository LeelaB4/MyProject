...
function insertData(id,id2,id3,id4,id5,id6,id7 ){
 ...
 */
 ...
 fetch(origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTTASK&method=GET&pract_id="+pract_id)  
.then(function(response) {  
 ...
 .catch(function(error) {                        // catch
  ...
  fetch(origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTTASK&method=GET&pract_id="+pract_id).then(data=> data.json())
 .then((data) => {
...
function CustPost(method){
		...
		
	{
		if(method === "POST")
		{
		   url_send_data=origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTTASK&method=POST&pract_id="+pract_id+"&"+"projectid="+projectid+"&"+
		 ...
		 "&"+"cust_Status="+cust_Status+"&"+"cust_Approver_statement="+cust_Approver_statement+"&"+"cust_Once_Auth="+cust_Once_Auth+"&"+"countRow="+countRow; 
		   ...
		   for(var index=0;index<document.getElementById('countRow').value;index++){
				  ...
				  url_send_data=url_send_data+"&parenttask"+index+"="+document.getElementById(parenttask).value.trim()+"&subtask"+index+"="+document.getElementById(subtask).value.trim()+"&startdate"+index+"="+document.getElementById(startdate).value.trim()+"&enddate"+index+"="+document.getElementById(enddate).value.trim()+
	...
	{ 
	  if(cust_mak !== userLogIn && document.getElementById("cust_Approver_statement").value === "Unauthorize"  ){
			...
			if (document.getElementById("cust_Once_Auth").value="Y" && document.getElementById("cust_Approver_statement").value === "Unauthorize")	   {
		 		...
		 		url_send_data=origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTTASK&method=UPDATE&pract_id="+pract_id+"&"+"projectid="+projectid+"&"+
				   "&"+"cust_maker="+cust_mak+"&"+"cust_maker_dt_stamp="+cust_maker_dt_stamp+"&"+"cust_Approver="+cust_Approver+"&"+"cust_Aprovertime="+cust_Aprovertime+
				 "&"+"cust_Status="+cust_Status+"&"+"cust_Approver_statement="+cust_Approver_statement+"&"+"cust_Once_Auth="+cust_Once_Auth+"&"+"countRow="+countRow; 
...
function approveData(){
	if(document.getElementById("cust_maker").value !== parent.document.getElementById("user_id").innerText.trim() && document.getElementById("cust_Approver_statement").value === "Unauthorize" && document.getElementById("cust_Once_Auth").value === "N"){
		 ...
		 fetch(origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTTASK&method=APPROVE&pract_id="+pract_id+"&"+"projectid="+projectid+"&"+"cust_maker="+cust_mak+"&"+
		 "cust_maker_dt_stamp="+cust_maker_dt_stamp+"&"+"cust_Approver="+ cust_Approver+"&"+"cust_Aprovertime="+cust_Aprovertime+
...
//	let cust_Aprovertime = document.getElementById("cust_Aprovertime").value;
	...
	let pract_id = document.getElementById("pract_id").value;
	 	...
	 	fetch(origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTTASK&method=REOPEN&pract_id="+pract_id	 +"&"+"projectid="+projectid+"&"+"cust_maker="+cust_mak+"&"+
		 "cust_maker_dt_stamp="+cust_maker_dt_stamp+"&"+"cust_Approver="+cust_Approver+"&"+"cust_Aprovertime="+cust_Aprovertime+
...
function CloseAcc(){
	...
	alert("Cannot Closed");
		...
		fetch(origin+"/"+parent.getProjectName()+"/Screen?function_id=TMPRACTTASK&method=CLOSE&pract_id="+pract_id+"&"+"projectid="+projectid+"&"+"&"+"cust_maker="+cust_mak+"&"+
				 "cust_maker_dt_stamp="+cust_maker_dt_stamp+"&"+"cust_Approver="+cust_Approver+"&"+"cust_Aprovertime="+cust_Aprovertime+
				 "&"+"cust_Status="+cust_StatusE+"&"+"cust_Approver_statement="+cust_Approver_statement+"&"+"cust_Once_Auth="+cust_Once_Auth+"&"+"countRow="+countRow);
...
function enbFilds(){
 ...
 function enbFilds1(){
			...
			document.getElementById('master_project_id').disabled = true;
			document.getElementById("master_project_name").disabled=true;
			document.getElementById('parent_project_id').disabled = true;
			document.getElementById('parent_project_name').disabled = true;
	} 
 ...
 function framecss(){
	 document.querySelector('#f1').style.setProperty('width','469px');
...
function addRow(tableID){
	...
	//element2.width="100";
	if(recivedArray.parent_task != undefined)
	{
	...
	var cell3 = row.insertCell(2);
	 var element3 = document.createElement("img");
	   ...
	   element3.id = "searcher" + c;
		...
		element3.style.left=" -5px";*/  id="parenttask0"
	
		
		  //element3.setAttribute('onclick', "frameinWin1('LOV_MODUSER_ROLE','MODUSER','List of Values ROLES');insertData('"+inputid+"','"+inputdesc+"')"); 
	
  element3.setAttribute('onclick', "frameinWin1('LOV_TMPRACTTASK3','TMPRACTTASK','List of Values');insertData('"+parenttask+"')"); 
	...
	element4.type = "text";
	element4.name = "task1" + c;
	element4.id = "task" + c;
	element4.style.width="143px"
	element4.autocomplete="off";
	
	if(recivedArray.task1 !=undefined){
		element3.value=recivedArray.task1;
	}
	...
	var cell5 = row.insertCell(4);
	 var element5 = document.createElement("img");
	   element5.src = src="Img/searcher.png";
	   element5.id = "searcher" + c;
		element5.width="20";
		element5.height="20";
		/*element3.style.position="relative";
  ...
  element5.setAttribute('onclick', "frameinWin1('LOV_TMPRACTTASK4','TMPRACTTASK','List of Values');insertData('"+task+"')"); 
	   ...
	   element6.type = "text";
	   element6.name = "sub_task" + c;
	   element6.id = "subtask" + c;
	   element6.style.width="143px"
		   element6.autocomplete="off";
		
		if(recivedArray.sub_task != undefined)
			{
			element6.value =recivedArray.sub_task; 
			}
		...
		cell6.appendChild(element6);
		  ...
		  cell7 = row.insertCell(6);
		   ...
		   element7.type = "date";
		   element7.name = "start_date" + c;
		   element7.id = "startdate" + c;
		   element7.style.width="143px"
			   element7.autocomplete="off";
			if(recivedArray.start_date != undefined)
				{
				element7.value =recivedArray.start_date; 
				}
