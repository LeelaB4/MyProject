	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<link href="TMCOMAST.css" rel="stylesheet" type="text/css" />
				<script type="text/javascript" src="TMCOMAST.js">
				</script>
...
">
							<xsl:for-each select="div/tbody">
								...
								<img id="imgLov"
									onclick="frameinWin('LOV_TMCOMAST','TMCOMAST','List 
									of Values Practional id');insertData('pract_id','pract_name')"
									src="Img/searcher.png" width="20" height="20"
									style="position: absolute;margin-left: 348px;margin-top: 63px;" />
									
									
										<img id="imgLov1"
									onclick="frameinWin('LOV_TMCOMAST1','TMCOMAST','List 
									of Values Practional id');insertData('pract_id','pract_name')"
									src="Img/searcher.png" width="20" height="20"
									style="position: absolute;margin-left: 348px;margin-top: 63px;" />
							...
							<div id="roletable">
								<table id="dataTable" class="table-bordered table-hover table-striped table">
									<thead id="table_css">
										...
										<th style=" width: 139px;font-size: 14px ">ASSET NO</th>
										<th></th>
										<th style=" width: 169px; font-size: 14px">ASSET_NAME</th>
										<th style=" width: 169px;font-size: 14px ">ASSET TYPE</th>
										<th style="width: 169px;font-size: 14px;position: absolute;">SERIAL NO</th>
										<th
											style="position: absolute;width: 429px;/* position: initial; */font-size: 14px">ASSET STARTDATE</th>
										<th style="width: 701px;position: absolute;font-size: 14px">ASSET ENDDATE</th>
										<th style="position: absolute;width: 1004px;font-size: 14px">STATUS</th>

										<tbody id="roletable"
											style="position: fixed;top: 240px;right: 8px;border: none;overflow-y: scroll;scroll-behavior: smooth;height: 290px;margin-left: 1128px;"></tbody>
